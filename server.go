...
func (c *Client) handleSocketMsg(m *SocketMsg) error {
	switch m.Type {
	case MsgJoinGame:
...
func (c *Client) handleFromGameMsg(m *FromGameMsg) error {
	switch m.typ {
	case MsgNewGame:
		c.handleMsgStart()
	case MsgGameOver:
